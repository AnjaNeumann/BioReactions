...
public class Server {
  ...
  private static final String APPLICATION_PATH = "gradoop/dashboard/index.html";
  ...
  private static HttpServer startServer() throws IOException {
    ...
    ResourceConfig rc = new PackagesResourceConfig("org.gradoop.vis");
  ...
  public static void main(String[] args) throws IOException {
    ...
    System.out.printf("org.gradoop.vis started at %s%s%n" +
