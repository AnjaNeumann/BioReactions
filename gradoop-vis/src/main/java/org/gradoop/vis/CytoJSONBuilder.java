...
public class CytoJSONBuilder {
   ...
   */
  static String getJSON(GraphHead graphHead, List<Vertex> vertices, List<Edge> edges,
                        Vector<Pair<String,String>> extra) throws
    JSONException {
...
//    }
    ...
    if (extra.size() != 0) {
      ...
      for (Pair<String, String> p : extra) {
        jo.put(p.getKey(), p.getValue());
      }
      returnedJSON.put(EXTRA, jo);
    }
