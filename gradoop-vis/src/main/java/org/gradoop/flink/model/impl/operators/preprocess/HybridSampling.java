 ...
 */
public class HybridSampling implements UnaryGraphToGraphOperator {
  /**
   ...
   */
  public HybridSampling(float sampleSize) {
    this(sampleSize, 0L);
  }
   ...
   */
  public HybridSampling(float sampleSize, long randomSeed) {
  ...
  public String getName() {
    return HybridSampling.class.getName();
  }
}
