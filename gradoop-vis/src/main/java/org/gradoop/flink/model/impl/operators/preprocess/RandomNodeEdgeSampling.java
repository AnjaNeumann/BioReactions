...
import org.gradoop.flink.model.impl.operators.preprocess.functions.EdgeRandomFilter;
import org.gradoop.flink.model.impl.operators.preprocess.functions.VertexRandomFilter;
 ...
 */
public class RandomNodeEdgeSampling implements UnaryGraphToGraphOperator {
  /**
   ...
   */
  public RandomNodeEdgeSampling(float sampleSize) {
    this(sampleSize, 0L);
  }
   ...
   */
  public RandomNodeEdgeSampling(float sampleSize, long randomSeed) {
  ...
  public LogicalGraph execute(LogicalGraph graph) {
    ...
    return LogicalGraph.fromDataSets(newVertices, newEdges, graph.getConfig());
  }
  ...
  public String getName() {
    return RandomNodeEdgeSampling.class.getName();
  }
}
